...
%_kde_bindir/kde4/artistictextshape.so
%_kde_bindir/kde4/autocorrect.so
%_kde_bindir/kde4/changecase.so
%_kde_bindir/kde4/commentshape.so
%_kde_bindir/kde4/defaulttools.so
%_kde_bindir/kde4/divineproportionshape.so
%_kde_bindir/kde4/generickofilter.so
%_kde_bindir/kde4/kodocinfopropspage.so
%_kde_bindir/kde4/kofficedockers.so
%_kde_bindir/kde4/kofficegoogledocs.so
%_kde_bindir/kde4/kofficescan.so
%_kde_bindir/kde4/kofficethumbnail.so
%_kde_bindir/kde4/kolcmsengine.so
%_kde_bindir/kde4/kopabackgroundtool.so
%_kde_bindir/kde4/koreport_barcodeplugin.so
%_kde_bindir/kde4/koreport_chartplugin.so
%_kde_bindir/kde4/koreport_shapeplugin.so
%_kde_bindir/kde4/musicshape.so
%_kde_bindir/kde4/paragraphtool.so
%_kde_bindir/kde4/pathshapes.so
%_kde_bindir/kde4/pictureshape.so
%_kde_bindir/kde4/pluginshape.so
%_kde_bindir/kde4/spellcheck.so
%_kde_bindir/kde4/textshape.so
%_kde_bindir/kde4/textvariables.so
%_kde_bindir/kde4/thesaurustool.so
%_kde_bindir/kde4/treeshape.so
%_kde_bindir/kde4/vectorshape.so
%_kde_bindir/kde4/videoshape.so
%_kde_bindir/kde4/xsltexport.so
%_kde_bindir/kde4/xsltimport.so
%_kde_bindir/libkdeinit4_kthesaurus.so
